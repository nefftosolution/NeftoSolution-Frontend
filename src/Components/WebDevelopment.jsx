      ...
      <section className="py-12 md:py-20 px-6 md:px-12 lg:px-24 relative">
        ...
        >
          ...
          <motion.p variants={itemVariants} className="text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed max-w-3xl font-medium">
            Working with your organisation’s strategic objectives in mind in a collaborative, transparent, <span className="text-primary font-semibold">Agile way</span>, our team of experts deliver secure, accessible, high-performing web applications.
          </motion.p>
        </motion.div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            >
              ...
              <div className="text-gray-600 text-lg md:text-xl leading-relaxed space-y-8">
                <p>
                  Leveraging the insights from our <span className="text-primary font-bold border-b-2 border-accent">UX and product design experts</span>, our team can create the right solutions for your organisation.
                </p>
                <p>
                  While <span className="text-primary font-bold border-b-2 border-accent">web accessibility audits</span> hone the platform, <span className="text-primary font-bold">Agile development</span> lets you test products faster.
                </p>
                <p>
                  Our <span className="font-bold text-primary">ISO 27001-certified</span> process adapts to fit your needs. We're proud to be <span className="text-accent font-bold border-b-2 border-accent">Laravel's first UK partner</span>.
                </p>
                <p>
                  We deliver <span className="text-primary font-bold border-b-2 border-primary">web applications using Laravel</span>, providing consultancy, support, and <span className="text-primary font-bold border-b-2 border-accent">API integration services</span>.
                </p>
              </div>
            </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
            ...
            >
              ...
              <div className="text-gray-600 text-lg md:text-xl leading-relaxed space-y-6">
                <p>
                  Throughout our web application development process, we ensure our code is fully <span className="text-primary font-bold border-b-2 border-accent">WCAG compliant</span>, going beyond the legal guidelines to be truly accessible.
                </p>
                <p>
                ...
                <p>
                  We have extensive experience in platforms like <span className="text-primary font-bold border-b-2 border-primary">Laravel</span> and <span className="text-primary font-bold border-b-2 border-primary">React</span>, but as a tech agnostic web app development agency, we’ll always select the right tech for your unique requirements.
                </p>
              </div>
            </motion.div>

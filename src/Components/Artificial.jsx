      ...
      <section className="py-12 md:py-20 px-6 md:px-12 lg:px-24 relative">
        ...
        >
          ...
          <motion.p variants={itemVariants} className="text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed max-w-3xl font-medium">
            Working with your data strategy in mind in a collaborative, transparent, <span className="text-primary font-semibold">Agile way</span>, our team of data scientists deliver secure, ethical, and high-performing AI models that drive growth.
          </motion.p>
        </motion.div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            >
              ...
              <div className="text-gray-600 text-lg md:text-xl leading-relaxed space-y-8">
                <p>
                  Leveraging the insights from our <span className="text-primary font-bold border-b-2 border-accent">Big Data and Analytics experts</span>, our team can create tailored AI models for your organisation.
                </p>
                <p>
                  While <span className="text-primary font-bold border-b-2 border-accent">Predictive performance audits</span> hone the accuracy, <span className="text-primary font-bold">Agile development cycles</span> let you validate ML products faster.
                </p>
                <p>
                  Our <span className="font-bold text-primary">ISO 27001-certified</span> process ensures data privacy in every model. We specialize in <span className="text-accent font-bold border-b-2 border-accent">TensorFlow and PyTorch development</span>.
                </p>
                <p>
                  We deliver <span className="text-primary font-bold border-b-2 border-primary">solutions using Python and OpenAI</span>, providing consultancy, model deployment, and <span className="text-primary font-bold border-b-2 border-accent">Real-time Inference services</span>.
                </p>
              </div>
            </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
            ...
            >
              ...
              <div className="text-gray-600 text-lg md:text-xl leading-relaxed space-y-6">
                <p>
                  Throughout our AI development process, we ensure our models are fully <span className="text-primary font-bold border-b-2 border-accent">Ethics-compliant</span>, going beyond standard algorithms to ensure fairness and transparency.
                </p>
                <p>
                ...
                <p>
                  We have extensive experience in frameworks like <span className="text-primary font-bold border-b-2 border-primary">Scikit-Learn</span> and <span className="text-primary font-bold border-b-2 border-primary">HuggingFace</span>, always selecting the right tools for your data requirements.
                </p>
              </div>
            </motion.div>

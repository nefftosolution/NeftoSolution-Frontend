...
const AboutHero = () => {
  ...
  return (
    <div className="pt-20 pb-30 w-full bg-light-50 flex flex-col items-center justify-center font-['Outfit'] relative overflow-hidden px-4">
      {/* Animation */}
      ...
      <div className="absolute bottom-10 md:bottom-4">
        <button 
          ...
          className="bg-accent-bright text-white w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform duration-300 animate-bounce cursor-pointer"
        >
          <svg 

...
const CapabilitiesGraphic = () => {
  // Graphic Design & Branding specific services
  const services = [
    ...
    "Illustration & Custom Iconography",
  ...
  return (
    <section className="bg-[#FAF9F6] py-16 px-6 md:px-12 lg:px-24 font-playfair">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Section Heading - Updated for Graphic Design */}
        <motion.h2 
...
export default CapabilitiesGraphic;